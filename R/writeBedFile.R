...
#' @param fragments A \code{\link[GenomicRanges]{GRanges}} object with strand and mapq metadata, such as that generated by \code{\link{readBamFileAsGRanges}}
#' @param deltaWs A \code{\link[GenomicRanges]{GRanges}} object with metadata column "deltaW" generated by \code{\link{deltaWCalculator}}.
#' @param breakTrack A \code{\link[GenomicRanges]{GRanges}} object with metadata "genoT" (e.g. newBreaks) will write a bedtrack with refined breakpoints.
#' @param confidenceIntervals A \code{\link[GenomicRanges]{GRanges}} object with metadata "genoT" the same length as \code{breakTrack} (e.g. confint) will write a bedtrack with breakpoints confidence intervals.
#' @param maskedRegions A \code{\link[GenomicRanges]{GRanges}} object.
#' @param hotspots A \code{\link[GenomicRanges]{GRanges}} object.
#' @param breaksGraph A \code{\link[GenomicRanges]{GRanges}} object.
