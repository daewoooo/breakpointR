...
#'            
writeBedFile <- function(index, outputDirectory, fragments=NULL, deltaWs=NULL, breakTrack=NULL, maskedRegions=NULL, hotspots=NULL, breaksGraph=NULL, col="103,139,139 243,165,97") {
