...
#'
#' Find breakpoints from deltaWs by <TODO:DAVID here a description of how breakpoints are found>.
#'
...
#' @param peakTh The treshold that the peak deltaWs must pass to be considered a breakpoint (e.g. 0.33 is 1/3 of max(delta)).
...
#' @return A \code{\link[GenomicRanges]{GRanges}} object containing breakpoint coordinates with various metadata columns.
